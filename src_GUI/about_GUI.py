...
class SoftInformationDialog(QDialog):
    ...
    def init_iu(self):
        ...
        home_page_label = QLabel("<a href='https://habby.wiki.inrae.fr'>http://habby.wiki.inrae.fr</a>")
        home_page_label.setOpenExternalLinks(True)
        github_page_label = QLabel("<a href='https://github.com/YannIrstea/habby'>http://github.com/YannIrstea/habby</a>")
