...
class InterpolationTab(QScrollArea):
    ...
    def init_ui(self):
        ...
        fish_available_qlabel = QLabel(self.tr('Select aquatic animal(s) :'))
        ...
        available_firstlayout = QGridLayout()
        # available_firstlayout.setAlignment(Qt.AlignTop)
        # available_firstlayout.setAlignment(Qt.AlignLeft)
        available_firstlayout.addWidget(habitat_filenames_qlabel, 0, 0, 1, 1)
        available_firstlayout.addWidget(self.hab_filenames_qcombobox, 0, 1, 1, 1)
        available_firstlayout.addWidget(habitat_reach_qlabel, 1, 0, 1, 1)
        available_firstlayout.addWidget(self.hab_reach_qcombobox, 1, 1, 1, 1)
        available_firstlayout.addWidget(unit_type_title_qlabel, 2, 0, 1, 1)
        available_firstlayout.addWidget(self.unit_type_qlabel, 2, 1, 1, 1)
        available_firstlayout.addWidget(unit_min_title_qlabel, 3, 0, 1, 1)
        available_firstlayout.addWidget(self.unit_min_qlabel, 3, 1, 1, 1)
        available_firstlayout.addWidget(unit_max_title_qlabel, 4, 0, 1, 1)
        available_firstlayout.addWidget(self.unit_max_qlabel, 4, 1, 1, 1)
        available_firstlayout.addWidget(fish_available_qlabel, 5, 0, 1, 1, Qt.AlignTop)
        available_firstlayout.addWidget(self.fish_available_qlistwidget, 5, 1, 2, 1)
        available_firstlayout.addWidget(self.export_empty_text_pushbutton, 6, 0, 1, 1, Qt.AlignLeft)
        ...
        self.display_required_units_from_sequence_pushbutton = QPushButton(self.tr("compute"))
        ...
        self.fromtext_qpushbutton = QPushButton(self.tr('load and compute'))
        ...
        """ Interpolated results """
        self.interpolated_results_group = QGroupBoxCollapsible(self.tr("Computed results"))
