...
def merge(hyd_xy, hyd_data_node, hyd_tin, iwholeprofile, hyd_data_mesh, sub_xy, sub_tin, sub_data, sub_default,
    ...
    """
    gridelt = griddef(hyd_xy, sub_xy, hyd_tin, sub_tin, coeffgrid, grid_method)  # building the grid
    # print(gridelt)
    # print ("titi")
...
def griddef(xyhyd, sub_xy, iklehyd, sub_tin, coeffgrid, gridmethod=0):
    '''
