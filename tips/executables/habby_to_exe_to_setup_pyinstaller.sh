...
source datas/env_virtuels/env_habby_dev_pip/bin/activate
...
datas/env_virtuels/env_habby_dev_pip/bin/pyinstaller tips/executables/habby.spec --distpath=build/pyinstaller --workpath=build/pyinstaller/temp --noconfirm
