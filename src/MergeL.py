...
def merge(hyd_xy, hyd_data_node, hyd_tin, iwholeprofile, hyd_data_mesh, sub_xy, sub_tin, sub_data, sub_default,
    ...
    :return:
            ...
            niklemerge1 :the merge TIN (Triangular Irregular Network) 3 columns of nodes indexes each line is a mesh/triangle
...
def build_hyd_sub_mesh_in_area(bshow, nbpointhyd, nbpointsub, seedhyd=None, seedsub=None,
                               rectangles=((0, 0, 100, 100),), contour=((0, 0), (100, 0), (100, 100), (0, 100))):
    if seedhyd != None:
        np.random.seed(seedhyd)
...
if __name__ == '__main__':
    ...
    if t == 0:  # random nbpointhyd, nbpointsub are the number of nodes/points to be randomly generated respectively for hydraulic and substrate TIN
        ...
        hyd_xy, hyd_tin, sub_xy, sub_tin, sub_data = build_hyd_sub_mesh_in_area(False, nbpointhyd, nbpointsub, seedhyd,
                                                                                seedsub, rectangles, hull)
    elif t == 8:
