...
def load_sub(sub_description, progress_value, q=[], print_cmd=False, project_properties={}):
    ...
    data_2d.sub_default_values = np.array(sub_description["sub_default_values"].split(",")).astype(data_2d.hvum.sub_dom.dtype)
    ...
    # not all_polygon_triangle_tf
        ...
        if triangle_records_list.min() < 0:
            ...
            for triangle_invalid_index in triangle_invalid_index_list:
                ...
                p2 = triangle_geom_list[triangle_invalid_index][1]
                p3 = triangle_geom_list[triangle_invalid_index][2]
